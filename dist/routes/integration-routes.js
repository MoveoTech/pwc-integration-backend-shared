...
const integrationRoutes = () => {
    ...
    router.post('/activate-tasks', (0, express_validator_1.body)('payload.boardIds.clientObligationBoardId').trim().escape(), (0, express_validator_1.body)('payload.boardIds.businessStreamBoardId').trim().escape(), (0, express_validator_1.body)('payload.boardIds.currentTaskboardBoardId').trim().escape(), (0, express_validator_1.body)('payload.parentsItemsData.*.parentItemId').toInt(), (0, express_validator_1.body)('payload.parentsItemsData.*.type').trim().escape(), (0, express_validator_1.body)('payload.parentsItemsData.*.items.*.itemName').trim().escape(), (0, express_validator_1.body)('payload.isLastTasksGroup').toBoolean(), monday_middleware_1.verifyClientAuthorization, activate_tasks_middleware_1.validateActivateTasksInputs, activate_tasks_controller_1.activateTasks);
    return router;
};
